...
%XenkoSdkBinDir%Xenko.Core.Assets.CompilerApp.exe --profile=Windows-OpenGLES --platform=Android --output-path=%~dp0obj\app_data --build-path=%~dp0obj\build_app_data --package-file=Graphics.xkpkg
