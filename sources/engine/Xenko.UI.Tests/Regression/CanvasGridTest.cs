...
namespace Xenko.UI.Tests.Regression
{
    ...
    public class CanvasGridTest : UITestGameBase
    {
        ...
        protected override async Task LoadContent()
        {
            ...
            image1.DependencyProperties.Set(Canvas.RelativePositionPropertyKey, new Vector2(0));
            image1.DependencyProperties.Set(Canvas.PinOriginPropertyKey, new Vector2(0));
