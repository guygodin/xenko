        ...
        public class SpriteSheetCommand : AssetCommand<SpriteSheetParameters>
        {
            ...
            protected override Task<ResultStatus> DoCommandOverride(ICommandContext commandContext)
            {
                ...
                foreach (var image in Parameters.SheetAsset.Sprites)
                {
                    ...
                    if (isPacking && spriteToPackedSprite.TryGetValue(image, out var packedSprite)) // ensure that unpackable elements (invalid because of null size/texture) are properly added in the sheet using the normal path
                    {
