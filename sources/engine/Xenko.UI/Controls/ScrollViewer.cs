...
namespace Xenko.UI.Controls
{
    ...
    public class ScrollViewer : ContentControl
    {
        ...
        {
            new HashSet<ScrollingMode> { ScrollingMode.Horizontal, ScrollingMode.HorizontalVertical },
            new HashSet<ScrollingMode> { ScrollingMode.HorizontalVertical, ScrollingMode.Vertical },
        };
        ...
        private Vector2 lastFrameTranslation;

        private Vector2 accumulatedTranslation;
        ...
        /// </remarks>
        public Vector2 ScrollPosition => -ScrollOffsets;
        ...
        public ScrollViewer()
        {
            ...
            {
                bar.Measure(Vector2.Zero); // set is measure valid to true
        ...
        {
            CurrentScrollingSpeed = Vector2.Zero;
        }
        ...
        /// </summary>
        protected Vector2 LastFrameTranslation => lastFrameTranslation;
        ...
        protected override void Update(GameTime time)
        {
                ...
                if (SnapToAnchors && ContentAsAnchorInfo != null)
                {
                    for (var i = 0; i < Dims; ++i)
                    {
                        ...
                        if (closestAnchorIndex == 1)
                        {
                            ...
                            var childRenderSize = (Vector2)VisualContent.RenderSize;
            ...
            if (lastFrameTranslation != Vector2.Zero)
            ...
            lastFrameTranslation = Vector2.Zero;
        }
        ...
        public void ScrollTo(Vector2 scrollAbsolutePosition, bool stopScrolling = true)
        {
            ...
            if (ContentAsScrollInfo != null)
            {
                var correctedScrollPosition = Vector2.Zero;
                foreach (var index in ScrollModeToDirectionIndices[ScrollMode])
        ...
        /// <param name="stopScrolling">Indicate if the scrolling should be stopped after the scroll action.</param>
        public void ScrollOf(Vector2 scrollTranslation, bool stopScrolling = true)
        {
            userManuallyScrolled = true;
        ...
        public void ScrollOfInternal(ref Vector2 scrollTranslation, bool stopScrolling)
        {
            if (stopScrolling)
            {
                HideScrollBars();
            ...
            var correctedScrollTranslation = Vector2.Zero;
            foreach (var index in ScrollModeToDirectionIndices[ScrollMode])
        ...
        private void UpdateScrollOffsets(Vector2 desiredScrollPosition)
        {
        ...
        private void UpdateScrollingBarsSize()
        {
            ...
            foreach (var index in ScrollModeToDirectionIndices[ScrollMode])
            {
                ...
                barSize.X = index == 0 ? Math.Min(1f, ViewPort.X / sizeChildren) * ViewPort.X : Math.Min(ScrollBarThickness, ViewPort.X);
                barSize.Y = index == 1 ? Math.Min(1f, ViewPort.Y / sizeChildren) * ViewPort.Y : Math.Min(ScrollBarThickness, ViewPort.Y);
        ...
        private void UpdateVisualContentArrangeMatrix()
        {
            ...
            var childOffsets = offsets + new Vector2(Padding.Left, Padding.Top) - ViewPort / 2;
        ...
        protected override void OnPreviewTouchDown(TouchEventArgs args)
        {
            ...
            StopCurrentScrolling();
            accumulatedTranslation = Vector2.Zero;
            IsTouchedDown = true;
        }
    ...
    internal class ScrollBarSorter : Comparer<UIElement>
    {
        public static readonly ScrollBarSorter Instance = new ScrollBarSorter();
